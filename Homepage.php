...
<body>
    <header class="navigation">
        <div class="nav-left">
            ...
            <div class="nav-left">
                <ul>
                    <li><a href="Login.php"><img src="image/log-in2.png" width="50px"></a></li>
                    <li><a href="Register.php"><img src="image/signup1.png" width="50px"></a></li>
                </ul>
            </div>
        </header>
                        ...
                        <div class="col-sm-3">
                          <div class="thumb-wrapper">
                            ...
                            <div class="thumb-content">
                              ...
                              <a href="#" class="btn btn-primary">Exlore</a>
                            </div>						
                          </div>
                        </div>								
                        <div class="col-sm-3">
